...
import { TemplateRef, AfterContentInit, ElementRef, NgZone, EventEmitter, QueryList, SimpleChanges } from '@angular/core';
 ...
 * @group Components
 */
declare class Carousel extends BaseComponent implements AfterContentInit {
    el: ElementRef;
    zone: NgZone;
    /**
...
declare class CarouselModule {
    ...
    static ɵmod: i0.ɵɵNgModuleDeclaration<CarouselModule, never, [typeof Carousel, typeof i1.SharedModule], [typeof Carousel, typeof i1.SharedModule]>;
    static ɵinj: i0.ɵɵInjectorDeclaration<CarouselModule>;
}

export { Carousel, CarouselClasses, CarouselModule, CarouselStyle };
export type { CarouselPageEvent, CarouselResponsiveOptions, CarouselTemplates };
