...
import { AfterViewInit, AfterContentInit, OnDestroy, ElementRef, TemplateRef, EventEmitter, QueryList } from '@angular/core';
...
declare class DrawerStyle extends BaseStyle {
    ...
    classes: {
        mask: ({ instance }: {
            ...
            'p-drawer-full': any;
            'p-overlay-mask p-overlay-mask-enter'?: undefined;
        })[];
        root: ({ instance }: {
            instance: any;
        }) => (string | {
 ...
 * @group Components
 */
declare class Drawer extends BaseComponent implements AfterViewInit, AfterContentInit, OnDestroy {
    /**
...
declare class DrawerModule {
    ...
    static ɵmod: i0.ɵɵNgModuleDeclaration<DrawerModule, never, [typeof Drawer, typeof i1.SharedModule], [typeof Drawer, typeof i1.SharedModule]>;
