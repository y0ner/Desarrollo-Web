...
import { AfterContentInit, OnDestroy, ElementRef, TemplateRef, EventEmitter, QueryList, NgZone } from '@angular/core';
 ...
 * @group Components
 */
declare class Popover extends BaseComponent implements AfterContentInit, OnDestroy {
    /**
