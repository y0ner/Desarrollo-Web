...
import { OnInit, OnDestroy, NgZone, ElementRef, TemplateRef, EventEmitter, QueryList } from '@angular/core';
 ...
 * @group Components
 */
declare class ConfirmDialog extends BaseComponent implements OnInit, OnDestroy {
 ...
 * @group Templates
 */
interface ConfirmDialogTemplates {
    /**
...
export type { ConfirmDialogTemplates };
